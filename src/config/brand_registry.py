...
BRAND_REGISTRY = {
    "bd_threatpulse": {
        ...
        "publishing_platforms": ["YouTube", "Facebook", "TikTok", "Instagram"],
        "facebook_page_id": "1142537835601306",
        "auto_publish": True,
        "daily_target": 4,
        "priority": "high",
    ...
    "wealthwise": {
        ...
        "publishing_platforms": ["YouTube", "Facebook", "TikTok"],
    ...
    "kids_universe": {
        ...
        "facebook_page_id": "1222424600959423",
        "auto_publish": True,
        "daily_target": 4,
        "priority": "medium",
    ...
    "philosophy": {
        ...
        "publishing_platforms": ["YouTube", "Facebook", "Instagram"],
        "facebook_page_id": "1154316767774881",
        "auto_publish": True,
        "daily_target": 4,
        "priority": "medium",
        "similarity_threshold": 0.80,
