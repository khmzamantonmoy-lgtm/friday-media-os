...
BRAND_PROFILES = {
    ...
    "philosophy": {
        "brand_id": "philosophy",
        "display_name": "Philosophy / Quotes",
        "voice_id": "en-US-Neural2-I",
        "visual_style": (
...
def seed_automation(db: firestore.Client) -> None:
    ...
    brand_configs = {
        "bd_threatpulse": {
            ...
            "publish_frequency_per_day": 2,
            "publish_windows": ["09:00-11:00", "18:00-21:00"],
        ...
        "wealthwise": {
            ...
            "publish_frequency_per_day": 1,
            "publish_windows": ["12:00-14:00"],
            "preferred_video_duration": 30,
