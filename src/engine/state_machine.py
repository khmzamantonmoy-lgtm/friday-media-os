...
class StateMachine:
    _transitions = {
        ...
        ContentState.RENDERING: [ContentState.RENDERED, ContentState.FAILED, ContentState.RETRY],
        ContentState.RENDERED: [ContentState.UPLOADING, ContentState.FAILED, ContentState.RETRY],
        ContentState.UPLOADING: [ContentState.PUBLIC, ContentState.FAILED, ContentState.RETRY],
